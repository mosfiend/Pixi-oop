...
this.projectBtnTransition1.beginFill(0x44ff44)
                      .drawCircle(0, 0, this.navWidth * 0.2)
                      this.projectBtnTransition1.x =this.navWidth*0.5

this.projectBtnTransition2.beginFill(0x44ff44)
...
this.projectBtnTransition3.beginFill(0x44ff44)
                      .drawCircle(0, 0, this.navWidth* 0.2)
...
this.project1.on('pointerdown', ()=>{if (this.activeProject.y !== this.project1.y &&
    (this.activeProject.y === this.project2.y || this.activeProject.y === this.project3.y)) this.activateProject1()});
this.project2.on('pointerdown', ()=>{if (this.activeProject.y !== this.project2.y &&
    (this.activeProject.y === this.project1.y || this.activeProject.y === this.project3.y)) this.activateProject2()});
this.project3.on('pointerdown', ()=>{if (this.activeProject.y !== this.project3.y &&
    (this.activeProject.y === this.project1.y || this.activeProject.y === this.project2.y)) this.activateProject3()});
this.project1.on('pointerover', ()=>{if (this.activeProject.y === this.project2.y|| this.activeProject.y === this.project3.y)
    new Tween(this.project1).to({alpha:1},300).start()});
this.project2.on('pointerover', ()=>{if (this.activeProject.y === this.project1.y|| this.activeProject.y === this.project3.y)
    new Tween(this.project2).to({alpha:1},300).start()});
this.project3.on('pointerover', ()=>{if (this.activeProject.y === this.project1.y|| this.activeProject.y === this.project2.y)
    new Tween(this.project3).to({alpha:1},300).start()});
this.project1.on('pointerout', ()=>{if (this.activeProject.y !== this.project1.y &&         // don't blur out active project
...
this.project2.on('pointerout', ()=>{if (this.activeProject.y !== this.project2.y && 
     (this.activeProject.y === this.project1.y|| this.activeProject.y === this.project3.y)) new Tween(this.project2).to({alpha:0.3},300).start()});
this.project3.on('pointerout', ()=>{if (this.activeProject.y !== this.project3.y &&
