...
// If current layer is a group, loop through the group, else if it's a layer loop through its data
        if (curLayer.data)    {    for (let j =0, curTile; j<curLayer["data"].length;j++) {
